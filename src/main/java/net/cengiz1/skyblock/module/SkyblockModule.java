...
/**
 * Implemented by the main class of every Skyblock module jar dropped into
 * {@code plugins/Skyblock/modules/}. The implementing class must have a public
 ...
 */
public interface SkyblockModule {
